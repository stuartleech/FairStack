    ...
    const handleUpload = () => {
        ...
        if (uploadConfig.enabled) {
            ...
            NiceModal.show(LimitModal, {
                ...
                prompt: uploadConfig.error || <>Your current plan only supports official themes. You can install them from the <a href="https://ghost.org/marketplace/">Fairstack theme marketplace</a>.</>,
